...
#define SSID "suraj1" // "SSID-WiFiname"
#define PASS "suraj@2374" // "password"
#define IP "184.106.153.149"// thingspeak.com ip

String msg = "GET /update?key=BU7NRIXX70WANGMB"; //change it with your api key like "GET
